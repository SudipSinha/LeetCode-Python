...
def longestCommonSubsequence_first(text1: str, text2: str) -> LCS:
    ...
    def lcs_aux(idx1: int, idx2: int) -> LCS:
        nonlocal lengths
        nonlocal subseqs
        ...
        if text1[idx1 - 1] == text2[idx2 - 1]:
            ...
            up = lcs_aux(idx1 - 1, idx2)
            left = lcs_aux(idx1, idx2 - 1)
    ...
    result = lcs_aux(idx1=len(text1), idx2=len(text2))
...
# def longestCommonSubsequence_all(text1: str, text2: str) -> LCS:
#     """Dynamic programming solution.
#     Time complexity: O(mn), space complexity: O(mn).
#     """
#     lengths = numpy.full(shape=(len(text1) + 1, len(text2) + 1), fill_value=-1)
